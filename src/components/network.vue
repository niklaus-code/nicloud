<template>
  <div class="col-sm-12" style="margin-top: 10px; padding-left:0; padding-right: 0">
    <button class="btn btn-success btn-sm" type="button" @click="createvlan" style="margin-right: 20px; margin-bottom: 12px; float: right">
      创建网络<span class="glyphicon glyphicon-plus" style="margin-left: 5px"></span>
    </button>
