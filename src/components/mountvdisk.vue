<template>
  <div>
    ...
    <div class="btn-group col-md-6" style="float: right">
      <button class="btn btn-default btn-sm" style="float:right; margin-right:5px" @click="search()"><span class="glyphicon glyphicon-search"></span>筛选</button>
