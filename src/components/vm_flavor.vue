  ...
  <div>
    ...
    <div class="col-sm-10 col-sm-offset-1" style="padding: 0; margin-top: 30px">
      <table class="table table-bordered" style="text-align: center; width: 100%">
        ...
        <tbody>
          <tr v-for="(c, index) in flavorlist" :key="c.id">
            <td>{{ index + 1 }}</td>
            <td>{{ c.Cpu }}</td>
            <td>{{ c.Mem }}</td>
          </tr>
    ...
    <div class="col-sm-10 col-sm-offset-1 choose" style="margin-top:30px; margin-bottom:30px">
      <div class="col-sm-2">
        <h5 style="margin-top: 8px">CPU</h5>
      </div>
      <div class="col-sm-3">
        <form role="form">
    ...
    <div class="col-sm-10 col-sm-offset-1 " style="margin-top:30px; margin-bottom:30px">
      <div class="col-sm-12" style="padding-bottom: 10px; color: red"></div>
    </div>
  </div>
</template>
<script>
