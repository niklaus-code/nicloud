<template>
  <div class="col-sm-12" style="margin-top: 10px;padding-right:0; padding-left:0">
    <button @click="createstorage" class="btn btn-success btn-sm" type="button" style="margin-bottom: 12px;margin-right: 20px; float: right">
      创建存储集群<span class="glyphicon glyphicon-plus" style="margin-left: 5px"></span>
    </button>
