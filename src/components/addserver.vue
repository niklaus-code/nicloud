  ...
  <div>
    <div class="col-sm-4 col-sm-offset-2" style="margin-top:50px">
      <form class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-sm-4 control-label">原厂序列号*</label>
          <div class="col-sm-8">
            <input class="form-control" v-model="xuliehao" placeholder="12345678" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">资产标签*</label>
          <div class="col-sm-8">
    ...
    <div class="col-sm-4" style="margin-top:50px">
      <form class="form-horizontal">
        <div class="form-group">
          <label class="col-sm-4 control-label">机柜*</label>
          <div class="col-sm-8">
            <input class="form-control" v-model="jigui" placeholder="h03" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">机柜资产标签*</label>
          <div class="col-sm-8">
            <input class="form-control" v-model="jiguizichanbiaoqian" placeholder="123456" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-4 control-label">机柜位置*</label>
          <div class="col-sm-8">
    ...
    <div class="col-sm-4 col-sm-offset-2" style="margin-top:50px;">
      <div class="col-sm-2 col-sm-offset-4" style="padding-left:10">
        <div class="form-group">
          <button class="btn btn-success" @click="addmachine">提交</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    getmachinelist() {
      sessionStorage.setItem('router', 'addserver')
    ...
    addmachine() {
      var apiurl = `/api/machine/addmachine`
      this.$http
        .get(apiurl, {
          params: {
            zichanmingcheng: this.zichanmingcheng,
            pinpai: this.pinpai,
            xinghao: this.xinghao,
            xuliehao: this.xuliehao,
            zichanbiaoqian: this.zichanbiaoqian,
            danwei: this.danwei,
            suoshubumen: this.suoshubumen,
            zichanzerenbumen: this.zichanzerenbumen,
            zerenren: this.zerenren,
            suoshujifang: this.suoshujifang,
            jigui: this.jigui,
            jiguizichanbiaoqian: this.jiguizichanbiaoqian,
            weizhi: this.weizhi,
            gaodu: this.gaodu,
            shebeizhuangtai: this.shebeizhuangtai,
            edinggonglv: this.edinggonglv,
            yongdiandengji: this.yongdiandengji,
            guanliip: this.guanliip,
            yewuip: this.yewuip,
            beizhu: this.beizhu
          }
        })
